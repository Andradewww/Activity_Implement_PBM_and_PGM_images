...
def gerar_histograma_cinza(nome_arquivo):
    ...
    #conta a quantidade de pixels em cada intensidade
    for pixel in pixels:
        histograma[pixel] += 1
    ...
    #leitura do CSV para gerar o grafico
    ...
    for linha in leitor:
        intensidades.append(int(linha["Intensidade"]))
        quantidades.append(int(linha["Quantidade"]))

    arquivo_csv.close()

    print("CSV da imagem Escala Cinza lido")

    #gera grafico usando os dados do CSV
    plt.figure()
...
def gerar_histograma_rgb(nome_arquivo):
    ...
    #leitura do CSV para gerar graficos
    ...
    for linha in leitor:
        ...
        valores_r.append(int(linha["Vermelho"]))

        valores_g.append(int(linha["Verde"]))

        valores_b.append(int(linha["Azul"]))

    arquivo_csv.close()

    print("CSV imagem RGB lido")
...
gerar_histograma_cinza(
    r"C:\Users\Thinkpad\OneDrive\Documentos\IFC\ProcessamentoDigitalImagens\Atividade_Img_01\Exercicios_10092026\EntradaEscalaCinza.pgm"
)

print("Imagem RGB:")

gerar_histograma_rgb(
    r"C:\Users\Thinkpad\OneDrive\Documentos\IFC\ProcessamentoDigitalImagens\Atividade_Img_01\Exercicios_10092026\EntradaRGB.ppm"
)
